...
export function DynamicComponent<Type extends keyof typeof DYNAMIC_COMPONENT_REGISTRY, Props extends Extract<DynamicComponentData,{type: Type}>>(props: Props) {
    return DYNAMIC_COMPONENT_REGISTRY[props.type].component(props as never);
}

export function DynamicComponentEditor<Type extends keyof typeof DYNAMIC_COMPONENT_REGISTRY, Props extends DynamicComponentEditorProps<Type, Extract<DynamicComponentData,{type: Type}>>>(props: Props) {
